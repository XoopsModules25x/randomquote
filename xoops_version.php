...
$modversion = array('name'                => _MI_RANDOMQUOTE_ADMIN_NAME,
                    ...
                    'help'                => 'page=help',
                    'helpsection'         => array(array('name' => _MI_RANDOMQUOTE_ADMIN_HELP,
                                                         'link' => 'page=help'),
                                                   array('name' => _MI_RANDOMQUOTE_ADMIN_HELP_FEATURES,
                    ...
                    // Search
                    'hasSearch'           => 1,
                    'search'              => array('file' => "include/search.inc.php",
                                                   'func' => 'randomquote_search'),

                    // Templates
                    'templates'           => array(array('file'        => 'randomquote_index.tpl',
                                                         'description' => 'randomquote index page'),
                                                   /*
                                                                                       array('file' => 'randomquote_quotes.tpl',
                                                                                      'description' => 'randomquote quotes page'),
                                                   */
                                                   array('file'        => 'randomquote_header.tpl',
                                                         'description' => 'randomquote header page'),

                                                   array('file'        => 'randomquote_footer.tpl',
                                                         'description' => 'randomquote footer page')),
                    //Blocks
                    'blocks'              => array(array('file'        => "views.php",
                                                         ...
                                                         'template'    => "randomquote_quotes_block_recent.tpl"),

                                                   array('file'        => "views.php",
                                                         'name'        => _MI_RANDOMQUOTE_QUOTES_BLOCK_DAY,
                                                         'description' => _MI_RANDOMQUOTE_QUOTES_BLOCK_DAY_DESC,
                                                         'show_func'   => 'showRandomquoteBlockViews',
                                                         'edit_func'   => 'editRandomquoteBlockViews',
                                                         'options'     => 'day|5|25|0',
                                                         'template'    => "randomquote_quotes_block_day.tpl"),
                                                   ...
                                                   array('file'        => "views.php",
                                                         ...
                                                         'template'    => "randomquote_quotes_block_random.tpl")),

                    // Config
                    'config'              => array(array('name'        => 'randomquote_editor',
