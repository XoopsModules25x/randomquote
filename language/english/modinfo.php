...
// Admin
define('_MI_RANDOMQUOTE_ADMIN_NAME', 'Random Quote');
...
define('_MI_RANDOMQUOTE_ADMIN_HELP', 'Help');
...
define('_MI_RANDOMQUOTE_ADMIN_HELP_FEATURES', 'Features');
...
define('_MI_RANDOMQUOTE_KEYWORDS_DESC', 'Insert keywords here (separate by comma)');
...
define('_MI_RANDOMQUOTE_IDPAYPAL_DESC', 'Insert here your PayPal ID for donations.');
...
define('_MI_RANDOMQUOTE_NAME', 'Randomquote');
define('_MI_RANDOMQUOTE_DIRNAME', basename(dirname(dirname(__DIR__))));
define('_MI_RANDOMQUOTE_HELP_HEADER', __DIR__ . '/help/helpheader.html');
define('_MI_RANDOMQUOTE_BACK_2_ADMIN', 'Back to Administration of ');
//define('_MI_RANDOMQUOTE_HELP_DIR', __DIR__);
//help
define('_MI_RANDOMQUOTE_HELP_OVERVIEW', 'Overview');
//define('_MI_RANDOMQUOTE_ADMIN_HELP', 'Overview');
//define('_MI_RANDOMQUOTE_ADMIN_HELP_FEATURES', 'Features');
